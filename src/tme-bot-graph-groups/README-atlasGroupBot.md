...
3. Give the bot a handle (ex: `atlasGroupBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://tmebotgraphgroups.azurewebsites.net/api/messages`
